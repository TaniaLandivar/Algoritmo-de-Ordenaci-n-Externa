 ...
 * @author Mateo
 */
public class MezclaDirectaKeyNumero {
    public MezclaDirectaKeyNumero(String ruta) throws IOException {
   ...
   private void mezclar(File f1, File f2, File f,int lonSec, int numReg) throws IOException{
       int numSec, resto, i, j, k,clave1 =0,clave2 = 0;
        ...
        clave1=Integer.parseInt(bf1.get(0));
        boolean is_end2 = bf2.readRecord();
        clave2=Integer.parseInt(bf2.get(0));
        ...
        for (int s = 1; s <= numSec+1; s++)
        {
            ...
            while (i <= n1 && j <= n2)
            {
                ...
                if (clave1 < clave2)
                {
                    ...
                    try {
                          ...
                          String clave1aux= bf1.get(0);

                        if(auxend1!=false)
                            clave1= Integer.parseInt(clave1aux);
                    }
                ...
                else
                {
                    ...
                    try {
                        ...
                        String clave2aux= bf2.get(0);
                        if(auxend2 !=false)
                            clave2= Integer.parseInt(clave2aux);
                    }
                    catch(EOFException e){;}
                    j++;
                }
                String clavem= String.valueOf(clave);
                pw.write(clavem);
                pw.write(getClave1);
                pw.write(getClave2);
                pw.write(getClave3);
            ...
            */
            for (k = i; k <= n1; k++)
            {   
                String clavem= String.valueOf(clave1);
                getClave1=bf1.get(1);
                getClave2=bf1.get(2);
                getClave3=bf1.get(3);
                pw.write(clavem);
            ...
            for (k = j; k <= n2; k++)
            {
                String clavem= String.valueOf(clave2);
                getClave1=bf2.get(1);
                getClave2=bf2.get(2);
                getClave3=bf2.get(3);
                pw.write(clavem);
